        ...
        case 'POST':
            ...
            switch ($data["valid"]){
                ...
                case 'userDateEvaluationDay':
                    ...
                    break;
                case 'userDayEvaluation':
                    http_response_code(200);
                    header('Content-Type: application/json');
                    echo json_encode(all::userDayEvaluation($data['month'],$data['year'],$data['day']));
                    break;                    
                case 'newProfiles':
                    http_response_code(200);
                    header('Content-Type: application/json');
                ...
                case 'validStartEvaluation':
                    ...
                    break;                    
                /*FIN  Evaluador*/
                case 'userDayMonthEvaluation':
                    http_response_code(200);
                    header('Content-Type: application/json');
                    echo json_encode(all::userMonthEvaluation($data['month'], $data['year']));
                    break;                     
